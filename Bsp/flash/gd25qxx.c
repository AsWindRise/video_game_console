...
/* SPI handle - use SPI1 as configured in CubeMX */
extern SPI_HandleTypeDef hspi1;

/**
 * @brief Initializes the SPI Flash chip.
 * @note This function assumes that the SPI peripheral (hspi1) and CS GPIO (PA4)
 *       have already been initialized by the STM32CubeMX generated code (MX_SPI1_Init(), MX_GPIO_Init()).
...
/**
 * @brief Read Flash Device ID using 0x90 command
 * @note  0x90 command sequence: CMD(1) + ADDR(3) + READ(2)
 *        Returns: Manufacturer ID (high byte) + Device ID (low byte)
 *        W25Q64: 0xEF17, W25Q128: 0xEF18, GD25Q64: 0xC817
 */
