...
// CS pin: PA4 (configured in CubeMX as SPI1_CS)
...
/* Initialize SPI Flash (assumes SPI1 and GPIO already initialized by CubeMX) */
...
/* read flash identification (returns Manufacturer ID << 8 | Device ID) */
