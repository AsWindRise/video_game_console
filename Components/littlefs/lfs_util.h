...
/*
 * STM32 Embedded System Configuration
 * Disable printf/assert to avoid system hang on bare-metal
 */
#define LFS_NO_DEBUG    /* Disable debug printf */
#define LFS_NO_WARN     /* Disable warning printf */
#define LFS_NO_ERROR    /* Disable error printf */
#define LFS_NO_ASSERT   /* Disable assert (can cause hang) */
/* Note: Do NOT define LFS_NO_MALLOC - it disables lfs_file_open() */
